//src/pages/admin/subpages/perritos.tsx
...
export default function PerritosAdmin() {
  ...
  const handleConfirm = async () => {
    try {
      switch (selectedAction) {
        case 0:
          console.log("📦 Enviando perrito nuevo al backend:", selectedItem);
  ...
  const filtered = data.filter((item) => {
    ...
    return searchFields.some((field) =>
      String(item[field as keyof Perrito])
        .toLowerCase()
        .includes(text)
    );
  });
  ...
  const columns = [
    ...
    { name: "Nombre", uid: "nombre", weight: 1 },
    { name: "Edad", uid: "edad", weight: 1 },
    { name: "Tamaño", uid: "tamañoPerro", weight: 1 },
    { name: "Descripción", uid: "descripcion", weight: 1 },
     { name: "Fecha de Registro", uid: "fechaRegistro" },
    { name: "Disponible", uid: "disponible", weight: 1 },
    { name: "Imágenes", uid: "imagenes", weight: 1 },
        ...
        return (
          <div className="flex items-center gap-1 justify-center">
            ...
            <Button
              ...
              className="p-1 text-red-600 min-w-0 h-7 w-7 flex items-center justify-center"
            >
